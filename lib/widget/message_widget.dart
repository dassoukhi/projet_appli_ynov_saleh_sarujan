...
import 'package:projet_appli_ynov/widget/reply_message_widget.dart';
...
class MessageWidget extends StatelessWidget {
      ...
      children: <Widget>[
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: isMe ? Colors.grey[200] : Colors.green[100],
            borderRadius: isMe
  ...
  Widget buildMessage() {
    final messageWidget = Text(message.message, style: TextStyle(color: Colors.black),);
